...
<html lang="en">
    <head>
        ...
        <link href="{{asset('user-assets/css/apexcharts.css')}}" rel="stylesheet">

        <link href="{{asset('user-assets/css/tooplate-mini-finance.css')}}" rel="stylesheet">
    ...
    <body>
        <header class="navbar sticky-top flex-md-nowrap">
            <div class="col-md-3 col-lg-3 me-0 px-3 fs-6">
                <a class="navbar-brand text-info" href="{{route('dashboard')}}">
                ...
                <div class="nav-item text-nowrap d-flex align-items-center">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('user-assets/images/social/search.png')}}" class="profile-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('user-assets/images/social/spotify.png')}}" class="profile-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('user-assets/images/social/telegram.png')}}" class="profile-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('user-assets/images/social/snapchat.png')}}" class="profile-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('user-assets/images/social/tiktok.png')}}" class="profile-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('user-assets/images/social/youtube.png')}}" class="profile-image img-fluid" alt="">
                    ...
                    <div class="dropdown px-3">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="{{asset('user-assets/images/medium-shot-happy-man-smiling.jpg')}}" class="profile-image img-fluid" alt="">
                        </a>
                        <ul class="dropdown-menu bg-white shadow">
                            <li>
                                <div class="dropdown-menu-profile-thumb d-flex">
                                    <img src="{{asset('user-assets/images/medium-shot-happy-man-smiling.jpg')}}" class="profile-image img-fluid me-3" alt="">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-3 d-md-block sidebar collapse">
                    <div class="position-sticky py-4 px-3 sidebar-sticky">
                        <ul class="nav flex-column h-100">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="wallet.html">
                                    <i class="bi-page me-2"></i>
                                        Promote Social Link
                                        {{-- <small>Groups/Pages/Chanel</small> --}}
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="profile.html">
                                    <i class="bi-pages me-2"></i>
                                    Link Pages
                                </a>
                            </li>
                            ...
                            <li class="nav-item featured-box mt-lg-5 mt-4 mb-4">
                                <img src="{{asset('user-assets/images/credit-card.png')}}" class="img-fluid" alt="">
                            ...
                            <div class="custom-block custom-block-exchange">
                                ...
                                <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('user-assets/images/flag/united-states.png')}}" class="exchange-image img-fluid" alt="">
                                ...
                                <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('user-assets/images/flag/singapore.png')}}" class="exchange-image img-fluid" alt="">
                                ...
                                <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('user-assets/images/flag/united-kingdom.png')}}" class="exchange-image img-fluid" alt="">
                                ...
                                <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('user-assets/images/flag/australia.png')}}" class="exchange-image img-fluid" alt="">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('user-assets/images/flag/european-union.png')}}" class="exchange-image img-fluid" alt="">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="custom-block custom-block-profile-front custom-block-profile text-center bg-white">
                                <div class="custom-block-profile-image-wrap mb-4">
                                    <img src="{{asset('user-assets/images/medium-shot-happy-man-smiling.jpg')}}" class="custom-block-profile-image img-fluid" alt="">
                            ...
                            <div class="custom-block custom-block-transations">
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('user-assets/images/profile/senior-man-white-sweater-eyeglasses.jpg')}}" class="profile-image img-fluid" alt="">
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('user-assets/images/profile/young-beautiful-woman-pink-warm-sweater.jpg')}}" class="profile-image img-fluid" alt="">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('user-assets/images/profile/young-woman-with-round-glasses-yellow-sweater.jpg')}}" class="profile-image img-fluid" alt="">
        ...
        <script src="{{asset('user-assets/js/apexcharts.min.js')}}"></script>
