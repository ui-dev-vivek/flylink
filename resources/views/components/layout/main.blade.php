...
<head>
    ...
    <title>{{ $metaData['title'] ?? 'fly-link:Social Promoter' }}</title>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="index.html">
                    ...
                    <span class="text-white">flylink</span>
                </a>
                    ...
                    <ul class="navbar-nav ms-lg-5 me-lg-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a class="dropdown-item" href="topics-listing.html"> <i class="bi bi-whatsapp"></i>
                                        / <i class="bi bi-facebook"></i> / <i class="bi bi-telegram"></i> Group
                                        Listing</a></li>

                                <li><a class="dropdown-item" href="contact.html">Create Promotional Page </a></li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <h1 class="text-white text-center">Promote Your Social Media Effortlessly</h1>

                        <h6 class="text-center text-black"><span class="grey">Shorten URLs, </span>Promote
                            Groups/ Chanels/ Pages, and
                            Link in Bio Tree</h6>

                        @livewire('elements.quick-short')
                    </div>
